...
class TestAcFr0101CoverageGate:
    ...
    def test_p0_p1_regression_with_boundary_control_cov_gate(self) -> None:
        ...
        cmd = [
            ...
            "--cov=src.boundary.validator",
            "--cov=src.boundary.contracts",
            "--cov=src.boundary.error_codes",
            "--cov=src.boundary.result_formatter",
            "--cov=src.boundary.constants",
            "--cov=src.boundary.error_mapper",
            "--cov=src.control",
            "--cov-fail-under=85",
            "-q",
        ]
